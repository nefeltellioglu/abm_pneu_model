...
from .disease_population import DisPopulation
from ..disease.disease_utils import add_at_risk_column

class AtRiskDisPopulation(DisPopulation):
    """
    ...
    def __init__(self,  logging=True):
        super(AtRiskDisPopulation, self).__init__()
