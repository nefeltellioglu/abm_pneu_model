...
class DiseaseObserverByAgeAtRisk(Observer):
   ...
   "fraction_prevalence_PPSV23_notPCV13_strains_in_ipd": tb.Float64Col(pos=11),
        ...
        "no_PPSV23_notPCV13_strains_in_ipd_per_age_group":  \
                                            tb.UInt32Col(pos=24,
                                                  shape=(self.no_age_groups)),
        "no_PCV15_notPCV13_strains_in_ipd_per_age_group":  \
                                            tb.UInt32Col(pos=25,
                                                  shape=(self.no_age_groups)),
        "no_PCV20_notPCV15_strains_in_ipd_per_age_group":  \
                                            tb.UInt32Col(pos=26,
                                                  shape=(self.no_age_groups)),
        "no_PCV13_notPCV7_strains_in_ipd_per_age_group":  \
                                            tb.UInt32Col(pos=27,
                                                  shape=(self.no_age_groups)),
        "no_PPSV23_notPCV20_strains_in_ipd_per_age_group":  \
                                            tb.UInt32Col(pos=28,
                                                  shape=(self.no_age_groups)),
                                            
        "tier_1_no_inds_per_age_group": \
                                            tb.UInt32Col(pos=29,
                                             shape=(self.no_age_groups)),                                    
        "tier_2_no_inds_per_age_group": \
                                            tb.UInt32Col(pos=30,
                                             shape=(self.no_age_groups)),                                    
        "tier_1_no_of_at_risk_cap_per_age_group": tb.UInt32Col(pos=31,
                                                  shape=(self.no_age_groups)), 
        "tier_1_no_of_at_risk_ipd_per_age_group": tb.UInt32Col(pos=32,
                                                  shape=(self.no_age_groups)), 
        "tier_2_no_of_at_risk_cap_per_age_group": tb.UInt32Col(pos=33,
                                                  shape=(self.no_age_groups)), 
        "tier_2_no_of_at_risk_ipd_per_age_group": tb.UInt32Col(pos=34,
                                                  shape=(self.no_age_groups)), 
                                            
                                            
        "tier_1_at_risk_no_PCV7_strains_in_ipd_per_age_group":  tb.UInt32Col(
                                            pos=35,shape=(self.no_age_groups)), 
        "tier_1_at_risk_no_PCV13_strains_in_ipd_per_age_group":  \
                                            tb.UInt32Col(pos=36,
                                                  shape=(self.no_age_groups)),
                                            
        "tier_1_at_risk_no_PPSV23_notPCV13_strains_in_ipd_per_age_group":  \
                                            tb.UInt32Col(pos=37,
                                                  shape=(self.no_age_groups)),
        "tier_2_at_risk_no_PCV7_strains_in_ipd_per_age_group":  tb.UInt32Col(
                                            pos=38,shape=(self.no_age_groups)), 
        "tier_2_at_risk_no_PCV13_strains_in_ipd_per_age_group":  \
                                            tb.UInt32Col(pos=39,
                                                  shape=(self.no_age_groups)),
        
        "tier_2_at_risk_no_PPSV23_notPCV13_strains_in_ipd_per_age_group":  \
                                            tb.UInt32Col(pos=40,
                                                  shape=(self.no_age_groups)),
        
        "no_v116_strains_in_ipd": tb.UInt32Col(pos=41),
        "no_v116_notppv23_strains_in_ipd": tb.UInt32Col(pos=42),                                    
        "no_v116_notpcv20_strains_in_ipd": tb.UInt32Col(pos=43),
        "no_v116_notpcv13_strains_in_ipd": tb.UInt32Col(pos=44),
        ...
        "fraction_prevalence_v116_notpcv13_strains_in_ipd": tb.Float64Col(
                                                                    pos=48), 
        "no_v116_strains_in_ipd_per_age_group":  tb.UInt32Col(pos=49,
                                                  shape=(self.no_age_groups)), 
       ...
       "no_v116_notpcv13_strains_in_ipd_per_age_group":  \
                                           tb.UInt32Col(pos=52,
                                                 shape=(self.no_age_groups)),
       "no_pcv20_strains_in_ipd_per_age_group":  tb.UInt32Col(pos=53,
                                                 shape=(self.no_age_groups)), 
       "no_v116_only_strains_in_ipd_per_age_group":  tb.UInt32Col(pos=54,
                                                 shape=(self.no_age_groups)), 
       "no_NVT_strains_in_ipd_per_age_group":  tb.UInt32Col(pos=55,
                                                 shape=(self.no_age_groups)), 
       "no_VT_strains_in_ipd_per_age_group":  tb.UInt32Col(pos=56,
                                                 shape=(self.no_age_groups)), 
       "no_pcv15_notpcv13_strains_in_ipd_per_age_group":  tb.UInt32Col(pos=57,
                                                 shape=(self.no_age_groups)), 
        "no_st8_in_ipd_per_age_group":  tb.UInt32Col(pos=58,
                                                  shape=(self.no_age_groups)), 
        "no_of_vaccinated_in_ipd_per_age_group": tb.UInt32Col(pos=59,
                                                  shape=(self.no_age_groups)), 
        "no_of_vaccinated_in_cap_per_age_group": tb.UInt32Col(pos=60,
                                                  shape=(self.no_age_groups)), 
        "no_of_vaccinated_in_ipd_atrisk_tier1_per_age_group": tb.UInt32Col(pos=61,
                                                  shape=(self.no_age_groups)), 
        "no_of_vaccinated_in_cap_atrisk_tier1_per_age_group": tb.UInt32Col(pos=62,
                                                  shape=(self.no_age_groups)), 
        "no_of_vaccinated_in_ipd_atrisk_tier2_per_age_group": tb.UInt32Col(pos=63,
                                                  shape=(self.no_age_groups)), 
        "no_of_vaccinated_in_cap_atrisk_tier2_per_age_group": tb.UInt32Col(pos=64,
                                                  shape=(self.no_age_groups)),
        "no_of_vaccinated_per_age_group": tb.UInt32Col(pos=65,
                                                  shape=(self.no_age_groups)), 
        "no_of_vaccinated_atrisk_tier1_per_age_group": tb.UInt32Col(pos=66,
                                                  shape=(self.no_age_groups)), 
        "no_of_vaccinated_atrisk_tier2_per_age_group": tb.UInt32Col(pos=67,
                                                  shape=(self.no_age_groups)), 
       ...
       "tier_1_at_risk_no_PCV20_notPCV15_strains_in_ipd_per_age_group":  \
        ...
        super(DiseaseObserverByAgeAtRisk, self).__init__(h5file =h5file, \
                            label = 'disease_byage', description = desc,
                            title = 'DiseaseObserverByAgeAtRisk')
    ...
    def update(self, t, pop, **kwargs):
        ...
        if t % self.interval == self.observed_day:
            ...
            all_pop_at_risk = (pop.I.select("at_risk", "age", "age_days", "vaccines")
                               .join(self.age_0_conversion,
                        on= ["age", "age_days"],how="left").with_columns(
                                (pl.when(pl.col("age_coef_by_age").is_null())
                                .then((pl.col("age") + 4))
                                .otherwise(pl.col("age_coef_by_age")))
            ...
            at_risk_counts_base = pl.DataFrame(
                pl.Series("age_coef_by_age", range(self.no_age_groups)))
            
            at_risk_counts1 = (all_pop_at_risk
                    .groupby(['age_coef_by_age', 'at_risk']) 
                    #.count()  #same as 
                    .agg(pl.count())
                    .pivot('count','age_coef_by_age','at_risk')
                    ).fill_null(0).sort("age_coef_by_age")
            at_risk_vaccinated = (all_pop_at_risk
                    .groupby(['age_coef_by_age', 'at_risk']) 
                    #.count()  #same as 
                    .agg((pl.col("vaccines").struct.field("no_of_doses") > 0).sum().alias("vaccinated"))
                    .pivot('vaccinated','age_coef_by_age','at_risk')
                    ).fill_null(0).sort("age_coef_by_age")
            at_risk_counts = at_risk_counts_base.join(
                     at_risk_counts1, on = "age_coef_by_age", how = "left"
                     ).fill_null(0).sort("age_coef_by_age")
            at_risk_vaccinated = at_risk_counts_base.join(
                     at_risk_vaccinated, on = "age_coef_by_age", how = "left"
                     ).fill_null(0).sort("age_coef_by_age")
            ...
            cap_age_groups = pl.DataFrame([
                pl.Series("age_coef_by_age", list(range(self.no_age_groups))),
                pl.Series("count", [0] * self.no_age_groups),
                pl.Series("vaccinated", [0] * self.no_age_groups),
                ]).update(
                   pop.disease_pop.filter(pl.col("disease") == "cap")
                   .group_by("age_coef_by_age").agg(pl.count(),
                    (pl.col("vaccines").struct.field("no_of_doses") > 0).sum().alias("vaccinated") ),
                  on = "age_coef_by_age", how= "left" ).sort("age_coef_by_age")
            ipd_age_groups = pl.DataFrame([
                ...
                pl.Series("st8", [0] * self.no_age_groups),
                   ...
                   .group_by("age_coef_by_age").agg(
                       count = pl.count(),
                      vaccinated = (pl.col("vaccines").struct.field("no_of_doses") > 0).sum(), 
            ...
            ###########at_risk aggregation
            at_risk_cap =  (pop.disease_pop.filter((pl.col("disease") == "cap") &
                                    (pl.col("at_risk") > 0))
             .group_by("age_coef_by_age", "at_risk").agg(pl.count(),
                  (pl.col("vaccines").struct.field("no_of_doses") > 0).sum().alias("vaccinated")).sort(
                      "at_risk", "age_coef_by_age"))
            at_risk_cap_vacc = at_risk_cap.select("age_coef_by_age", "at_risk", "vaccinated")
            at_risk_cap_age_groups = pl.DataFrame([
                pl.Series("age_coef_by_age", 
                                          list(range(self.no_age_groups)) * 2),
                pl.Series("count", [0] * self.no_age_groups * 2),
                pl.Series("at_risk", [1] * self.no_age_groups + 
                                      [2] * self.no_age_groups).cast(pl.Int32),
                ])
            at_risk_cap_age_groups = at_risk_cap_age_groups.update(at_risk_cap,
                  on = ["age_coef_by_age", "at_risk"], how= "left" ).sort(
                      "at_risk", "age_coef_by_age").join(
                         at_risk_cap_vacc,on = ["age_coef_by_age", "at_risk"],
                         how= "left" ).fill_null(0).sort(
                            "at_risk", "age_coef_by_age")
            
                             
            at_risk_ipd =  (pop.disease_pop.filter((pl.col("disease") == "ipd") &
                                    (pl.col("at_risk") > 0))
             .group_by("age_coef_by_age", "at_risk").agg(pl.count(),
                  (pl.col("vaccines").struct.field("no_of_doses") > 0).sum().alias("vaccinated")))
            at_risk_ipd_vacc = at_risk_ipd.select("age_coef_by_age", "at_risk", "vaccinated")                 
                             
            at_risk_ipd_age_groups = pl.DataFrame([
                pl.Series("age_coef_by_age", 
                          list(range(self.no_age_groups)) * 2),
                pl.Series("count", [0] * self.no_age_groups * 2),
                pl.Series("pcv7_strains", [0] * self.no_age_groups * 2),
                pl.Series("pcv13_strains", [0] * self.no_age_groups * 2),
                pl.Series("ppsv23_strains", [0] * self.no_age_groups * 2),
                pl.Series("ppsv23_notpcv13_strains", 
                          [0] * self.no_age_groups * 2),
                pl.Series("at_risk", [1] * self.no_age_groups + 
                                      [2] * self.no_age_groups).cast(pl.Int32),
                ]).update(
                   pop.disease_pop.filter((pl.col("disease") == "ipd") &
                   ...
                   .group_by("age_coef_by_age", "at_risk").agg(
                       count = pl.count(),
                    pcv7_strains = pl.sum("pcv7_strains"),
                    pcv13_strains = pl.sum("pcv13_strains"),
                    ppsv23_strains = pl.sum("ppsv23_strains"),
                ppsv23_notpcv13_strains = pl.sum("ppsv23_notpcv13_strains")),
                  on = ["age_coef_by_age", "at_risk"], how= "left" ).join(
                     at_risk_ipd_vacc,on = ["age_coef_by_age", "at_risk"],
                     how= "left" ).fill_null(0).sort(
                      "at_risk","age_coef_by_age")
            
            at_risk_ipd_cases = pop.disease_pop.filter(
                    (pl.col("disease") == "ipd") & (pl.col("at_risk") > 0) )
            ...
            self.row["tier_1_no_inds_per_age_group"] = \
                at_risk_counts["1"]
            self.row["tier_2_no_inds_per_age_group"] = \
                at_risk_counts["2"]
            
                
            self.row["tier_1_no_of_at_risk_cap_per_age_group"] = \
                at_risk_cap_age_groups.filter(
                    pl.col("at_risk") == 1)["count"].to_list()
            
            self.row["tier_1_no_of_at_risk_ipd_per_age_group"] = \
                at_risk_ipd_age_groups.filter(
                    pl.col("at_risk") == 1)["count"].to_list()
            
            self.row["tier_2_no_of_at_risk_cap_per_age_group"] = \
                at_risk_cap_age_groups.filter(
                    pl.col("at_risk") == 2)["count"].to_list()
            
            self.row["tier_2_no_of_at_risk_ipd_per_age_group"] = \
                at_risk_ipd_age_groups.filter(
                    pl.col("at_risk") == 2)["count"].to_list()
            
            self.row["tier_1_at_risk_no_PCV7_strains_in_ipd_per_age_group"] = \
                at_risk_ipd_age_groups.filter(
                    pl.col("at_risk") == 1)["pcv7_strains"].to_list()
            self.row[
            "tier_1_at_risk_no_PCV13_strains_in_ipd_per_age_group"] = \
                at_risk_ipd_age_groups.filter(
                    pl.col("at_risk") == 1)[
                        "pcv13_strains"].to_list()
            self.row[
        "tier_1_at_risk_no_PPSV23_notPCV13_strains_in_ipd_per_age_group"] = \
                at_risk_ipd_age_groups.filter(
                  pl.col("at_risk") == 1)["ppsv23_notpcv13_strains"].to_list()
            
                        
           
            self.row["tier_2_at_risk_no_PCV7_strains_in_ipd_per_age_group"] = \
               at_risk_ipd_age_groups.filter(
                   pl.col("at_risk") == 2)["pcv7_strains"].to_list()
            self.row[
           "tier_2_at_risk_no_PCV13_strains_in_ipd_per_age_group"] = \
               at_risk_ipd_age_groups.filter(
                   pl.col("at_risk") == 2)[
       ...
       "tier_2_at_risk_no_PPSV23_notPCV13_strains_in_ipd_per_age_group"] = \
               at_risk_ipd_age_groups.filter(
                pl.col("at_risk") == 2)["ppsv23_notpcv13_strains"].to_list()             
            ...
            self.row["no_of_vaccinated_in_ipd_per_age_group"] = \
                ipd_age_groups["vaccinated"].to_list()
            self.row["no_of_vaccinated_in_cap_per_age_group"] = \
                cap_age_groups["vaccinated"].to_list()
            self.row["no_of_vaccinated_in_ipd_atrisk_tier1_per_age_group"] = \
                at_risk_ipd_age_groups.filter(
                    pl.col("at_risk") == 1)["vaccinated"].to_list()
            self.row["no_of_vaccinated_in_ipd_atrisk_tier2_per_age_group"] = \
                at_risk_ipd_age_groups.filter(
                    pl.col("at_risk") == 2)["vaccinated"].to_list()
            self.row["no_of_vaccinated_in_cap_atrisk_tier1_per_age_group"] = \
                at_risk_cap_age_groups.filter(
                                    pl.col("at_risk") == 1)["vaccinated"].to_list()
            self.row["no_of_vaccinated_in_cap_atrisk_tier2_per_age_group"] = \
                at_risk_cap_age_groups.filter(
                    pl.col("at_risk") == 2)["vaccinated"].to_list()
                
            self.row["no_of_vaccinated_per_age_group"] = \
                popsize_age_groups["vaccinated"].to_list()
            self.row["no_of_vaccinated_atrisk_tier1_per_age_group"] = \
                at_risk_vaccinated["1"]
            self.row["no_of_vaccinated_atrisk_tier2_per_age_group"] = \
                 at_risk_vaccinated["2"]
            """
            #the below outputs are removed
            self.row[
            "tier_1_at_risk_no_PCV15_notPCV13_strains_in_ipd_per_age_group"]=\
                at_risk_ipd_age_groups.filter(
                    pl.col("at_risk") == 1)[
                        "no_PCV13_strains_in_ipd_per_age_group"].to_list()
                        
           tier_1_at_risk_no_PCV20_notPCV15_strains_in_ipd_per_age_group             
           tier_1_at_risk_no_PPSV23_notPCV20_strains_in_ipd_per_age_group           
           tier_2_at_risk_no_PCV20_notPCV15_strains_in_ipd_per_age_group             
           tier_2_at_risk_no_PPSV23_notPCV20_strains_in_ipd_per_age_group           
