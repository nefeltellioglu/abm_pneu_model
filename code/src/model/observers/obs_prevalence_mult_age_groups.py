...
class PrevalenceObserver(Observer):
    def __init__(self, h5file, strains):
        ...
        self.age_day_limits = { 
        'strain_list_2_4mo': \
                         (period * (60//period), (period * (120//period))),
        'strain_list_4_6mo': \
                         (period * (120//period), (period * (180//period))),
        'strain_list_6_8mo': \
                         (period * (180//period), (period * (240//period))),
        'strain_list_8_10mo': \
                         (period * (240//period), (period * (300//period))),
        'strain_list_10_12mo': \
                         (period * (300//period), (period * (364//period))),
