...
from model.disease.varying_transmission_disease_simulation import \
                                            VaryingTransDisSimulation
...
from model.disease.varying_transmission_disease import \
                                                VaryingTransmissionDisease



from model.disease.contact_matrix import KnownContactMatrix
from model.disease.varying_transmission_run import go_single
...
class DiseaseModel(VaryingTransmissionDisease):
    """
